...
#filter by gimupa
parser.add_argument('--fusibile_exe_path', type=str, default="/home/gdyang/UW_MVS_Benchmark/2022_UniMVSNet/fusibile/fusibile")
    ...
    with torch.no_grad():
        for batch_idx, sample in enumerate(TestImgLoader):
            ...
            for filename, cam, img, depth_est, photometric_confidence in zip(filenames, cams, imgs, \
                ...
                depth_color.save(os.path.join(args.outdir, filename.format('depth_est', '.png')))
