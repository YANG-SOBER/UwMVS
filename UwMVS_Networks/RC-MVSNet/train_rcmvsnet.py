...
parser.add_argument('--mode', default='test', help='train or test', choices=['train', 'test']) # test
parser.add_argument('--model', default='mvsnet', help='select model')
parser.add_argument('--device', default='cuda', help='select model')

parser.add_argument('--dataset', default='dtu_train', help='select dataset')
parser.add_argument('--trainpath', default="/home/gdyang/Downloads/Data/UW_MVS/UwMVS",help='train datapath')
parser.add_argument('--testpath', default="/home/gdyang/Downloads/Data/UW_MVS/UwMVS",help='test datapath')
parser.add_argument('--trainlist', default="./lists/dtu/train.txt",help='train list')
parser.add_argument('--testlist', default='./lists/dtu/val.txt',help='test list') # val.txt
...
parser.add_argument('--logdir', default='./ckpts/greenish', help='the directory to save checkpoints/logs')
...
parser.add_argument('--true_gpu',default="0, 1",help='using true gpu')
parser.add_argument('--gpu',default=[0, 1],help='gpu')
