...
parser.add_argument('--testpath', default="/home/gdyang/Downloads/Data/dtu/Underwater/Greenish",help='test datapath')
...
parser.add_argument('--loadckpt', default='./ckpts/greenish/greenish.ckpt', help='load a specific checkpoint')
parser.add_argument('--outdir', default='./outputs/dtu_greenish', help='output dir')
